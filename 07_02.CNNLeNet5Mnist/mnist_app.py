...
#We add this file ourselves for verification.
...
def pre_process_pic(testpic_path):
	...
	#将预处理后的image[1, 784] reshape 成[1, 28, 28, 1]
	img_pped_reshaped = np.reshape(img_pped, [1, fwp.IMAGE_XY_RES, fwp.IMAGE_XY_RES, fwp.IMAGE_CHANS])

	return img_pped_reshaped
